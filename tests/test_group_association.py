...
def _build_model() -> GroupAssociationModel:
    ...
    for uid in sample_ids:
        mutation_rows.append({"UNIQUEID": uid, "MUTATION": "shared", "GENE": "g0", "IS_SYNONYMOUS": False})
    for uid in sample_ids[10:]:
        mutation_rows.append({"UNIQUEID": uid, "MUTATION": "mut_x", "GENE": "g1", "IS_SYNONYMOUS": False})
