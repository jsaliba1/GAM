...
class GamSchema:
    ...
    mutation_is_synonymous_column: str | None = "IS_SYNONYMOUS"
...
def build_gam_run_config(data: dict[str, Any]) -> GamRunConfig:
    ...
    schema = GamSchema(
        ...
        mutation_is_synonymous_column=schema_data.get(
            "mutation_is_synonymous_column", "IS_SYNONYMOUS"
        ),
    ...
    return GamRunConfig(
        ...
        profile_output_file=Path(
            output_data.get("profile_pvalues_file", "gam_profile_pvalues.csv")
        ),
